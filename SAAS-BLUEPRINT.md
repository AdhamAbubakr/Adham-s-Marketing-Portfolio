...
| **P2** | Workflow Engine | جدول `workflow_handoffs` + Inbox/Handoff في كل بورتال |
| **P3** | AI Toolkit column | `ai_tools` + الـ right column في كل بورتال + launcher |
| **P4** | Knowledge Base | upload + default playbooks (نبدأ بـ Media Buyer) |
